...
public class MeshCombiner : MonoBehaviour
{
	...
	[SerializeField]
	private bool createMultiMaterialMesh = true, combineInactiveChildren = false, deactivateCombinedChildren = false,
		deactivateCombinedChildrenMeshRenderers = false, generateUVMap = false, destroyCombinedChildren = true;
	[SerializeField]
